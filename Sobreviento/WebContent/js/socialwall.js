    ...
    $.fn.socialTimeLine = function(options) {
        ...
        var Feed = {
                ...
                getData: function(account) {
                    ...
                    if ((settings.facebook.token != undefined) && (account != undefined)) {
                        ...
                        var limit = 'limit=' + settings.facebook.limit,
                            ...
                            api_version = 'v2.3/',
                            request = Feed.facebook.graph + api_version + account + '/posts?' + limit + token + callback_str;
            ...
            twitter: {
                ...
                utility: {
                    ...
                    getDataPosts: function(element, i) {
                        ...
                        var tweet = {},
                            entities_media, info = container.find('.social-info .social-info-twitter');
            ...
            instagram: {
                ...
                getData: function(account) {
                    ...
                    if ((settings.instagram.client_id != undefined) && (account != undefined)) {
                        var url = Feed.instagram.api + 'users/search/?q=' + settings.instagram.account + '&client_id=' + settings.instagram.client_id + '&count=1&callback=?';
                ...
                utility: {
                    getUser: function(user) {
                        if (user.data) {
                            if (user.data[0]) {
                                var url = Feed.instagram.api + 'users/' + user.data[0].id + '/media/recent/?client_id=' + settings.instagram.client_id + '&count=' + settings.instagram.limit + '&callback=?';
                                Utility.request(url, Feed.instagram.utility.getDataUser);
                            }
                        }

                    },
                    getDataUser: function(json) {
                        Feed.instagram.len = json.data.length;
                    ...
                    getDataPosts: function(element, i) {
                        ...
                        var photo = {},
                            ...
                            info = container.find('.social-info .social-info-instagram');
            ...
            pinterest: {
                ...
                utility: {
                    ...
                    getDataPosts: function(element, i) {
                        ...
                        var pin = {},
                            info = container.find('.social-info .social-info-pinterest'),
                            pom, photo;
                        pin.id = element.id;
            ...
            vkontakte: {
                ...
                utility: {
                    ...
                    getDataPosts: function(element, i) {
                        ...
                        var post = {},
                            info = container.find('.social-info .social-info-vkontakte'),
        ...
        var Render = {
            facebook: function(post) {
                ...
                var data = post,
                    fb = container.find('.facebook'),
                    info = container.find('.social-info .social-info-facebook');
            ...
            instagram: function(photo, i) {
                ...
                var data = photo,
                    disable, html, result, instagram = container.find('.instagram'),
            ...
            pinterest: function(pin, i) {
                ...
                var pinterest = container.find('.pinterest'),
                    result, html = '',
                    disable, image,
            ...
            vkontakte: function(post, i) {
                ...
                var vkontakte = container.find('.vkontakte'),
                    result, html = '',
                    disable, image,
